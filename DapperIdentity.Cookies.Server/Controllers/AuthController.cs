...
namespace CPE.DapperIdentity.Cookies.Server.Controllers
{
    ...
    class AuthController : ControllerBase
    {
        ...
        // JwtSettings was injected here and never read - assigned to a field nothing touched.
        // The type had no reader anywhere in the repo and was deleted 2026-09-14; the JWT path
        // builds its own settings record inside TokenService.
